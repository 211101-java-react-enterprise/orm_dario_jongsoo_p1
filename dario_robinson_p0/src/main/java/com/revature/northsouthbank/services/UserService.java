...
public class UserService {
    ...
    public boolean registerNewUser(AppUser newUser) {
        ...
        if(!isUserValid(newUser)) {
            throw new InvalidRequestException("Invalid user data provided! Please try again.");
        }
        ...
        if (!usernameAvailable || !emailAvailable) {
           String msg = "The username or email entered is already taken by another user." ;
